...
#crie uma variável recebendo uma lista das 4 variáveis, logo em seguida crie outra variável recebendo a importação , essa importação irá realizar o sorteio de um valor recebido.
